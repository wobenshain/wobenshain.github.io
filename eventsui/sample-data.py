...
for i in range (1,100000):
  curr_event = {}
  last_time = last_time-random.randint(10,10000)
  curr_event['time'] = datetime.datetime.fromtimestamp(last_time).strftime('%Y-%m-%d %H:%M:%S')
  curr_event['value'] = random.randint(1,50)
  curr_event['type'] = event_types[random.randint(0,14)]
